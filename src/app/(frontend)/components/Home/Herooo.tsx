...
const HeroVideoSection = () => {
  const videos = [
    {
      id: 1,
      videoUrl: '/video/Cut-01_hls/playlist.m3u8', // HLS stream URL
      poster: '/poster1.jpg',
      title: (
        <>
          {' '}
    ...
    {
      id: 2,
      videoUrl: '/video/Cut-02_hls/playlist.m3u8', // HLS stream URL
      poster: '/poster2.jpg',
      title: 'Modern Design',
    },
    {
      id: 3,
      videoUrl: '/video/Cut-03_hls/playlist.m3u8', // HLS stream URL
      poster: '/poster3.jpg',
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <div className="max-w-4xl">
              <h1
                className={`playflair text-[47px] md:text-5xl lg:text-[58px] xl:text-[78px] 2xl:text-[78px] min-[1920px]:text-[91px] font-normal mb-6 leading-tight xl:leading-[1.2] lg:pb-[30px] xl:pb-[62px]`}
              >
               {videos[currentVideoIndex].title}
              </h1>
            </div>
            <div className="flex gap-5 items-center pb-[80px] xl:pb-[92px]">
              <p className="text-white font-inter text-[14px] uppercase xl:text-[15px] font-normal">
