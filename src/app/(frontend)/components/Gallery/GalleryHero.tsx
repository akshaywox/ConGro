    ...
    <section className="relative text-white">
      ...
      <div className="absolute inset-0 flex flex-col justify-end x-6 px-6 md:px-10 xl:px-16">
        <div className="max-w-4xl">
          ...
          <MotionWrapper>
            <h1
              className={`${cormorant.className} w-[90%] md:w-[60%] lg:w-[70%] xl:w-[90%] 2xl:w-[95%] text-5xl lg:text-[70px] xl:text-[92px] 2xl:text-[100px] font-medium mb-6 !leading-[1.2] pb-20 md:pb-16`}
            >
              Experience the World of Confident Living
            </h1>
          </MotionWrapper>
